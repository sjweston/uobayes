...
.light[PMAP 8521: Bayesian Analysis<br>
...
.box-5.medium[If we can't use statistics to assert causation<br>how are we going to use this information<br>in Bayesian Analysis?]
