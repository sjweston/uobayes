...
Write a function that computes the posterior distribution of $p$, the true proportion of water, based on a given sample and a flat prior. The input of this function should be (1) a sample and (2) a vector of possible parameter values of $p$. Within the function, you'll need to caluculate the following value:
