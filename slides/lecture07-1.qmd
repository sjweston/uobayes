...
[You can download my model file here.](https://github.com/sjweston/uobayes/raw/refs/heads/main/files/share/m71.3.rds)
------------------------------------------------------------------------
...
[You can download my model file here.](https://github.com/sjweston/uobayes/raw/refs/heads/main/files/share/m71.4.rds)
------------------------------------------------------------------------
...
\text{PA.std}_{ij} &= \alpha_i + \beta_i(\text{day}_{ij}) + \epsilon_{ij} \\
\text{Level 2} &\\
\alpha_j &= \gamma_{00} + \gamma_{00}\text{female}_j + U_{0j} \\
\beta_j  &= \gamma_{10} + \gamma_{10}\text{female}_j + U_{1j}  \\
\end{align*}
...
[You can download my model file here.](https://github.com/sjweston/uobayes/raw/refs/heads/main/files/share/m71.5.rds)
