...
\chapter{Week 2: Geocentric models}\label{week-2-geocentric-models}

\section{Class 1: Geocentric models (Part I)}\label{class-1-geocentric-models-part-i}

Before class, be sure to \href{https://www.youtube.com/watch?v=tNOu-SEacNU&list=PLDcUM9US4XdPz-KxHM4XHt7uUVGWWVSus&index=4}{watch the lecture by McElreath}.

\subsection{Slides}\label{slides-1}

Download the slides \href{lectures/lecture02-1.html}{here}.
